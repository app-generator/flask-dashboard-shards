...
Open-source **[Flask Dashboard](https://appseed.us/admin-dashboards/flask)** generated by `AppSeed` op top of a modern design. A high-quality & free Bootstrap admin dashboard template pack that comes with lots of templates and components. Based on Bootstrap 4, **[Shards Dashboard](https://appseed.us/admin-dashboards/flask-dashboard-shards)** is fully responsive and capable to adapt its layout to any viewport size - Design provided by DesignRevision.
